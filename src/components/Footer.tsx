        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/robotsqueen/" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            <h3 className="font-bold text-white text-lg mb-4">Productos</h3>
            <ul className="space-y-2">
              <li><a href="#soluciones" className="text-gray-400 hover:text-white transition-colors">Robots de Telepresencia</a></li>
              <li><a href="#soluciones" className="text-gray-400 hover:text-white transition-colors">Robots Recepcionistas</a></li>
              <li><a href="#eventos" className="text-gray-400 hover:text-white transition-colors">Robots para Eventos</a></li>
              <li><a href="#contacto" className="text-gray-400 hover:text-white transition-colors">Catálogo Completo</a></li>
              <li><a href="#contacto" className="text-gray-400 hover:text-white transition-colors">Accesorios</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#contacto" className="text-gray-400 hover:text-white transition-colors">Alquiler para eventos</a></li>
              <li><a href="#contacto" className="text-gray-400 hover:text-white transition-colors">Mantenimiento</a></li>
              <li><a href="#contacto" className="text-gray-400 hover:text-white transition-colors">Personalización</a></li>
              <li><a href="#contacto" className="text-gray-400 hover:text-white transition-colors">Soporte técnico</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+34900123456" className="hover:text-white transition-colors">+34 654 942 720</a>
              </li>
            </ul>
          </div>
        </div>
